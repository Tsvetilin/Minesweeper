...
public:
	...
	void WriteBoard(BoardLook boardLook, BoardSettings boardSize, const char const* const* board, const char const * statusMessage);
	void WriteBoard(BoardLook boardLook, BoardSettings boardSize, ushort currentRowIndex, ushort currentColIndex, const char const* const * board, const char const* statusMessage);
